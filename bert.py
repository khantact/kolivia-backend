...
smallDataset = getDataset(
    path="data/appointments/appointments.txt", tokenizer=tokenizer, percent=0.05
)
trainDataset = getDataset(
    path="data/appointments/appointments.txt", tokenizer=tokenizer, percent=0.25
)
evalDataset = getDataset(
    path="data/eval_appointments/appointments.txt", tokenizer=tokenizer
)
